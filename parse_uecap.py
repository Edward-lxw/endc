...
def my_test2(in_text):
    for lines in in_text.splitlines():
        print(lines)
def get_uecap(in_text):
    ...
    endc_result_list = []
    get_mrdc(in_text)
    get_combination(in_text)
    get_nrdl_com_cc(in_text)
    get_nrul_com_cc(in_text)
    get_ltedl_com_cc(in_text)
    get_ltedl_com_cfg(in_text)
...
def get_mrdc(in_text):
    ...
    for curline in in_text.splitlines():
